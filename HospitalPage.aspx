<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.Master" AutoEventWireup="true" CodeBehind="HospitalPage.aspx.cs" Inherits="HospitalBill.WebForms.HospitalPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="form-content">
        ...
        <asp:Panel ID="pnl_GridView" runat="server"
            ...
            <asp:GridView ID="gv_PatientBillsData" class="gv_PatientBillsData" runat="server" 
                ...
                AllowPaging="True" OnPageIndexChanging="gv_PatientBillsData_PageIndexChanging" PageSize="2" Height="175px" Width="1212px">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImageButton1" ImageUrl="" CommandName="Edit" ToolTip="Edit" runat="server" />
                            <asp:ImageButton ID="ImageButton2" ImageUrl="" CommandName="Delete" ToolTip="Delete" runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:ImageButton ID="btn_Update" ImageUrl="" Width="20px" Height="20px" CommandName="Update" ToolTip="Update" runat="server" />
                            <asp:ImageButton ID="btn_Cancel" ImageUrl="" Width="20px" Height="20px" CommandName="Cancel" ToolTip="Cancel" runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
    ...
    <div class="buttons-content">
       ...
       <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:INTERVIEWConnectionString %>" InsertCommand="INSERT INTO PatientsDetails() VALUES ()" SelectCommand="spAddBill" SelectCommandType="StoredProcedure">
            <SelectParameters>
                ...
                <asp:Parameter Name="Fee" Type="Int64" />
            </SelectParameters>
        </asp:SqlDataSource>--%>
